...
??? note "Full tool list"
    ...
    **APT packages:**
    nmap, gobuster, dirb, nikto, sqlmap, metasploit-framework, hydra, john, hashcat, wpscan, enum4linux, theharvester, recon-ng, dnsenum, sslyze, bloodhound, impacket-scripts, responder

    **Go tools:**
    nuclei, httpx, subfinder, ffuf, assetfinder, waybackurls
